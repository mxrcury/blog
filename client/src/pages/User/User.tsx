...
import { useSelector, useDispatch, clearChosenUser } from "../../redux";
...
const User = () => {
    ...
    const addComment = async () => {
        ...
        dispatch(addCommentToUser(addedComment.comment));
    };
    console.log(chosenUser, "in User.tsx");
    return (
            ...
            <div style={{ marginTop: "40px" }}>
                ...
                <div style={{ textAlign: "center" }}>
                    ...
                    <div style={{ display: "flex", justifyContent: "space-between", gap: "5px" }}>
                        {chosenUser.skills
                            ? chosenUser.skills.split(",").map((skill) => (
                                <div
                                    style={{
                ...
                <div style={{ display: "flex", justifyContent: "start", marginBottom: "10px" }}>
                    <Input name="comment" onChange={onChange} value={commentInput.value} placeholder="Enter a text" />
                    ...
                    {chosenUser.comments
                        ? chosenUser.comments.map((comment) => (
                            ...
                            >
                                ...
                                <p>{comment.text}</p>
                                <p style={{ textAlign: "end", color: "gray", fontSize: "14px", marginRight: "5px" }}>
                                    {comment.createdAt}
                                </p>
                            </div>
                        ))
